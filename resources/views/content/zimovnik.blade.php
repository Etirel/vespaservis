<body class="page-template-default page page-id-296 wp-custom-logo wp-embed-responsive index"  >
...
<div id="header" class="header      " >
    <div class="container clearfix">
        <div id="logo">
            <a href="https://vespaservis011.rs/" class="custom-logo-link" rel="home"><img width="225" height="96" src="https://vespaservis011.rs/wp-content/uploads/2019/03/cropped-logo5-1.png" class="custom-logo" alt="VESPA SERVIS 011" /></a>          </div>
        <div id="main-menu-wrapper">
            ...
            <nav class="navigation clearfix mobile-menu-wrapper">
                <ul id="menu" class="menu"><li id="menu-item-38" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-38"><a href="https://vespa.test/">Početna</a></li>
                    <li id="menu-item-39" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-39"><a href="https://vespa.test/usluge-servisa/">Usluge servisa</a>
                        <ul class="sub-menu">
                            <li id="menu-item-286" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-286"><a href="https://vespa.test/redovno-odrzavanje/">REDOVNO ODRŽAVANJE</a></li>
                            ...
                            <li id="menu-item-300" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-296 current_page_item menu-item-300"><a href="https://vespa.test/zimovnik/" aria-current="page">ZIMOVNIK</a></li>
                        </ul>
                    </li>
...
<div class="clearfix"></div><div class="page-title svg_enable parallax-lite">
    <div data-center="background-position: 50% 0px" data-top-bottom="background-position: 50% -100px;" class="demo-image" style="background-image:url('https://vespaservis011.rs/wp-content/uploads/2019/05/snoweflake-close-up-cold.jpg')">
        <div class="overlay-demo"></div>
        <div class="full-fs-caption">
            <div class="caption-container">
                <h2 class="title overtext">ZIMOVNIK</h2>
            </div>
        </div>
    </div>
