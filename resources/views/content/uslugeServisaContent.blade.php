<body class="page-template-default page page-id-19 wp-custom-logo wp-embed-responsive index"  >
        ...
        <div id="main-menu-wrapper">
            ...
            <nav class="navigation clearfix mobile-menu-wrapper">
                <ul id="menu" class="menu"><li id="menu-item-38" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-38"><a href="https://vespa.test/">Početna</a></li>
                    <li id="menu-item-39" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-19 current_page_item menu-item-has-children menu-item-39"><a href="https://vespa.test/usluge" aria-current="page">Usluge Servisa</a>
                        <ul class="sub-menu">
                    ...
                    <li id="menu-item-44" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-44"><a href="https://vespaservis011.rs/galerija/">Galerija</a></li>
                </ul>            </nav>
        </div>
    </div>
</div>
<div class="clearfix"></div><div class="page-title svg_enable parallax-lite">
    <div data-center="background-position: 50% 0px" data-top-bottom="background-position: 50% -100px;" class="demo-image" style="background-image:url('https://vespaservis011.rs/wp-content/uploads/2019/05/vespa-usluge.jpg')">
        <div class="overlay-demo"></div>
        <div class="full-fs-caption">
            <div class="caption-container">
                <h2 class="title overtext">Usluge servisa</h2>
            </div>
        </div>
    </div>
